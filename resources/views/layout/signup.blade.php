  ...
  <div class="min-h-full flex">
    <div class="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
      <div class="mx-auto w-full max-w-sm lg:w-96">
        <div>
          <!-- <img class="h-14 w-auto" src="https://tailwindui.com/img/logos/workflow-mark-stone-600.svg" alt="Workflow"> -->
          <h2 class="mt-6 text-3xl font-extrabold text-stone-700">Global Islamic Students Alliance</h2>
        ...
        <div class="mt-8">
          ...
          <div class="mt-6">
            <form enctype="multipart/form-data" action="{{ route('handle-signup') }}" method="POST" class="space-y-6">
              @csrf
              ...
              <div class="mt-1 sm:mt-0 sm:col-span-2">
                <div class="flex items-center">
                  ...
                  <button type="button" class="ml-5 bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-stone-500">Upload</button>
                </div>
              </div>
              ...
              <div>
                ...
                <div class="mt-1">
                  <input id="name" name="name" type="text" autocomplete="name" required value="{{ old('name') }}" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-stone-500 focus:border-stone-500 sm:text-sm">
                </div>
              </div>
              ...
              <fieldset class="mt-6">
                ...
                <div class="mt-3 space-y-2">
                  <div class="flex items-center">
                    <input {{ old('gender') == 'male' ? 'checked' : '' }} required id="push-everything" name="gender" value="male" type="radio" class="focus:ring-stone-500 h-4 w-4 text-stone-600 border-gray-300">
                    <label for="push-everything" class="ml-3 block text-sm font-medium text-gray-700">Male</label>
                  </div>
                  <div class="flex items-center">
                    <input {{ old('gender') == 'female' ? 'checked' : '' }} required id="push-email" name="gender" value="female" type="radio" class="focus:ring-stone-500 h-4 w-4 text-stone-600 border-gray-300">
                    <label for="push-email" class="ml-3 block text-sm font-medium text-gray-700">Female</label>
                  </div>
                </div>
              </fieldset>

              <div>
                <button type="submit" class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-stone-600 hover:bg-stone-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-stone-500">Register and Unite</button>
              </div>
            </form>
          </div>
        </div>
